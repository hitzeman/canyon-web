...
/**
 * Placeholder catalog. This is a plain module so every page that reads it is
 * prerendered at build time. Swapping it for a CMS or database later only
 * means making these functions async — the pages already `await` them.
 */
